...
pkglibexecdir = $(libexecdir)/gst-plugins-ugly
...
A52DEC_CFLAGS = 
A52DEC_LIBS = -la52 -lm
ACLOCAL = ${SHELL} /usr/src/gst-plugins-ugly/gst-plugins-ugly/missing aclocal-1.14
...
AR = ar
AS = as
AUTOCONF = ${SHELL} /usr/src/gst-plugins-ugly/gst-plugins-ugly/missing autoconf
AUTOHEADER = ${SHELL} /usr/src/gst-plugins-ugly/gst-plugins-ugly/missing autoheader
AUTOMAKE = ${SHELL} /usr/src/gst-plugins-ugly/gst-plugins-ugly/missing automake-1.14
AWK = gawk
CC = gcc -std=gnu99
CCASFLAGS = 
...
GETTEXT_PACKAGE = gst-plugins-ugly-1.0
...
GST_CFLAGS = -I$(top_srcdir)/gst-libs -I$(top_builddir)/gst-libs -pthread -I/usr/include/gstreamer-1.0 -I/usr/include/glib-2.0 -I/usr/lib/glib-2.0/include    -DG_THREADS_MANDATORY -DG_DISABLE_CAST_CHECKS -DG_DISABLE_ASSERT $(GST_OPTION_CFLAGS)
...
GST_CURRENT = 8
GST_CXXFLAGS = -I$(top_srcdir)/gst-libs -I$(top_builddir)/gst-libs -pthread -I/usr/include/gstreamer-1.0 -I/usr/include/glib-2.0 -I/usr/lib/glib-2.0/include    -DG_THREADS_MANDATORY -DG_DISABLE_CAST_CHECKS -DG_DISABLE_ASSERT $(GST_OPTION_CXXFLAGS)
...
GST_PLUGINS_ALL =  asfdemux dvdlpcmdec dvdsub xingmux realmedia
...
GST_PLUGINS_SELECTED =  asfdemux dvdlpcmdec dvdsub xingmux realmedia
...
MAD_LIBS = -lmad
MAINT = 
MAKEINFO = ${SHELL} /usr/src/gst-plugins-ugly/gst-plugins-ugly/missing makeinfo
MANIFEST_TOOL = :
MKDIR_P = /usr/bin/mkdir -p
MPEG2DEC_CFLAGS = -I/usr/include/mpeg2dec  
MPEG2DEC_LIBS = -lmpeg2  
...
PACKAGE_STRING = GStreamer Ugly Plug-ins 1.0.9
...
abs_builddir = /usr/src/gst-plugins-ugly/gst-plugins-ugly
abs_srcdir = /usr/src/gst-plugins-ugly/gst-plugins-ugly
abs_top_builddir = /usr/src/gst-plugins-ugly/gst-plugins-ugly
abs_top_srcdir = /usr/src/gst-plugins-ugly/gst-plugins-ugly
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /usr/src/gst-plugins-ugly/gst-plugins-ugly/install-sh
